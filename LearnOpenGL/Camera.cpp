...
static glm::vec3 camPos(0, 0, 3);
static glm::vec3 camFront(0, 0, -1);
static glm::vec3 camUp(0, 1, 0);
...
int Camera()
{
	...
	Shader shader("shaders/coordinate-systems.vs", "shaders/coordinate-systems.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		int cubeCnt = sizeof(cubePositions) / sizeof(glm::vec3);
...
void processInput(GLFWwindow* window)
{
	...
	if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS)
		camPos -= glm::normalize(glm::cross(camFront, camUp)) * moveSpeed * deltaTime;
