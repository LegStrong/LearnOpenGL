...
int Transformations()
{
	...
	Shader shader("shaders/transformations.shader.vs", "shaders/transformations.shader.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 t = glm::translate(identity, glm::vec3(1.f, 0.f, 0.f));
		glm::mat4 s = glm::scale(identity, glm::vec3(0.5, 0.5, 0.5));
		glm::mat4 r = glm::rotate(identity, (float)glfwGetTime(), glm::vec3(0.0, 0.0, 1.0));
